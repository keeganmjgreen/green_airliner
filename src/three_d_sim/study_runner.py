    ...
    if view != "map-view":
        ...
        if track_airplane_id == "Airliner":
            ...
            zoom = [
                ...
                (d["Airliner-ascended-point"] + 5, 0.05),
                (d["PIT-UAV-0-on-airliner-docking-point"] - 0.3, 0.05),
                (d["PIT-UAV-0-on-airliner-undocking-point"], 5),
                (d["PIT-UAV-0-on-airliner-undocking-point"] + 0.1, 5),
                (d["PIT-UAV-0-on-airliner-undocking-point"] + 0.7, 0.8),
                (d["Airliner-curve-over-PIT-start-point"] - 5, 0.1),
                (d["Airliner-curve-over-PIT-start-point"] - 2, 0.07),
                (d["Airliner-curve-over-PIT-start-point"] + 1, 0.1),
                (d["PIT-UAV-1-on-airliner-docking-point"] - 0.3, 0.8),
                (d["PIT-UAV-1-on-airliner-undocking-point"], 5),
                (d["PIT-UAV-1-on-airliner-undocking-point"] + 0.3, 0.1),
                (d["PIT-UAV-1-on-airliner-undocking-point"] + 3, 0.02),
                (d["PIT-UAV-1-on-airliner-undocking-point"] + 23, 0.001),
                (d["DEN-UAV-0-on-airliner-docking-point"] - 10, 0.0005),
                (d["DEN-UAV-0-on-airliner-docking-point"] - 3, 0.02),
                (d["DEN-UAV-0-on-airliner-docking-point"] - 0.3, 0.05),
                (d["DEN-UAV-0-on-airliner-undocking-point"], 5),
                (d["DEN-UAV-0-on-airliner-undocking-point"] + 0.5, 0.3),
                ((d["Airliner-curve-over-DEN-start-point"] + d["Airliner-curve-over-DEN-end-point"]) / 2, 0.07),
                (d["DEN-UAV-3-on-airliner-docking-point"] - 5, 0.3),
                (d["DEN-UAV-4-on-airliner-undocking-point"], 0.5),
                (d["DEN-UAV-4-on-airliner-undocking-point"] + 1, 0.02),
                (d["DEN-UAV-4-on-airliner-undocking-point"] + 25, 0.001),
                (d["Airliner-descent-point"] - 5, 0.001),
                (d["Airliner-descent-point"], 0.5),
                (d["Airliner-landing-point"], 0.5),
                (d["Airliner-landed-point"], 5),
